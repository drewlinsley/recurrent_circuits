...
CUDA_VISIBLE_DEVICES=2 python run_job.py --ckpt=/media/data_cifs/cluttered_nist_experiments/checkpoints/BSDS_vgg_gratings_horizontal_bigger_gratings_2019_11_06_08_42_44_520011/model_4500.ckpt-4500 --model=BSDS_vgg_gratings_horizontal_bigger --train=BSDS500_test_landscape --val=BSDS500_test_landscape --experiment=gratings_test_bsds --test --placeholders --out_dir=gratings --no_db
