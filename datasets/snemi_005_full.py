...
class data_processing(object):
    def __init__(self):
        self.name = 'snemi_005_full'
        self.output_name = 'snemi_005_full'
        self.contour_dir = '/media/data_cifs/connectomics/datasets/isbi_2013_0.npz'
        self.config = Config()
        self.affinity = False
        self.im_size = [512, 512]  # 600, 600
        self.model_input_image_size = [512, 512, 1]  # [107, 160, 3]
        self.nhot_size = [26]
        ...
        self.train_split = np.ceil(80 * 0.05).astype(int)
        self.val_split = 80
    ...
    def gather_windows(
        ...
        if window_size == volume.shape[1]:
            ...
            strides = np.arange(0, volume.shape[1] - window_size + stride_size, stride_size)
